 ...
 * CS:APP Data Lab 
 * 
 * Isabel Alvarado Blanco Uribe - icalvaradoblanco
 * 
...
/* 
 * oddBits - return word (32 bit integer) with all odd-numbered bits set to 1
 *   Legal ops: ! ~ & ^ | + << >>
 *   Max ops: 8
 *   Rating: 2
 
 Right most bit is 0 and left most bit is 31
 Final answer 10101010 10101010 10101010 10101010
 */
int oddBits(void) {
    int word = 0xAA;
    int mask = 0xAA;
...
Returns 1 if x = 10000000 00000000 00000000 00000000
 */
int isTmin(int x) {
  return !((x+x) | (!x));
